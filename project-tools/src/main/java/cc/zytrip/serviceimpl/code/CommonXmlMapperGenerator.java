 ...
 */
public class CommonXmlMapperGenerator extends CommonCodeGenerator implements ICommonCodeGenerator {
	private String pageEncoding = "UTF-8";

	private String targetFileDir;

	public CommonXmlMapperGenerator(String workspace, String thirdPack) {
		workspace += "/src/main/java";
		if (super.spaceMap.get("xmlPath") == null) {
			super.createPath(workspace, thirdPack);
		}
		this.targetFileDir = super.spaceMap.get("xmlPath");
	...
	public void excute(Configuration conf, Map<String, Object> clazz) throws Exception {
		...
		String fileName = targetFileDir + "/" + clazz.get("modelName") + "Dao.xml";
