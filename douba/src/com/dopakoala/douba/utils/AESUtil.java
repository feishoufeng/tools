...
public class AESUtil {
	 ...
	 */
	private String key = AchieveUtils.getConfVal("aes_key");
	private String ivParameter = AchieveUtils.getConfVal("aes_key");
	...
	public static String Encrypt(String encData, String secretKey, String vector) {
		try {
			...
			ExceptionMsgUtil.getInstance(AESUtil.class, e);
			return "";
		}
	}
