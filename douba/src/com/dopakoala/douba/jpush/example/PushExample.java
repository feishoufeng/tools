package com.dopakoala.douba.jpush.example;
...
import com.dopakoala.douba.jpush.CreateClient;
import com.dopakoala.douba.jpush.PushStyle;
...
public class PushExample {
	...
	public static void push() {
		...
		extras.put("type", "Register");
		PushPayload payload = PushStyle.pushWithExtras(Audience.alias("5"), "你好!", "这是一个推送",extras);
		try {
	...
	public static PushPayload buildPushObject_android_and_ios() {
		return PushPayload.newBuilder().setPlatform(Platform.android_ios()).setAudience(Audience.alias("5"))
