...
import com.dopakoala.douba.rongcloud.messages.TxtMessage;
import com.dopakoala.douba.rongcloud.messages.VoiceMessage;
import com.dopakoala.douba.rongcloud.models.*;
import com.dopakoala.douba.rongcloud.utils.GsonUtil;
...
public class Example {
	...
	public static void main(String[] args) throws Exception {
		...
		// 获取 Token 方法
		TokenReslut userGetTokenResult = rongCloud.user.getToken("userId1", "username",
				"http://www.rongcloud.cn/images/logo.png");
		System.out.println("getToken:  " + userGetTokenResult.toString());

		// 刷新用户信息方法
		CodeSuccessReslut userRefreshResult = rongCloud.user.refresh("userId1", "username",
				"http://www.rongcloud.cn/images/logo.png");
		...
		CodeSuccessReslut messagePublishPrivateResult = rongCloud.message.publishPrivate("userId1",
				messagePublishPrivateToUserId, messagePublishPrivateVoiceMessage, "thisisapush",
				"{\"pushData\":\"hello\"}", "4", 0, 0, 0);
		...
		try {
			...
			CodeSuccessReslut messagePublishTemplateResult = rongCloud.message
			...
			ExceptionMsgUtil.getInstance(Example.class, e);
		} finally {
			if (null != reader) {
				reader.close();
			}
		...
		CodeSuccessReslut messagePublishSystemResult = rongCloud.message.PublishSystem("userId1",
		...
		try {
			...
			TemplateMessage publishSystemTemplateTemplateMessage = (TemplateMessage) GsonUtil.fromJson(reader,
					TemplateMessage.class);
			CodeSuccessReslut messagePublishSystemTemplateResult = rongCloud.message
		...
		CodeSuccessReslut messagePublishGroupResult = rongCloud.message.publishGroup("userId",
		...
		CodeSuccessReslut messagePublishDiscussionResult = rongCloud.message.publishDiscussion("userId1",
		...
		CodeSuccessReslut messagePublishChatroomResult = rongCloud.message.publishChatroom("userId1",
		...
		CodeSuccessReslut messageBroadcastResult = rongCloud.message.broadcast("userId1", messageBroadcastTxtMessage,
		...
		CodeSuccessReslut groupRollBackGagUserResult = rongCloud.group.rollBackGagUser(groupRollBackGagUserUserId,
				"groupId1");
		...
		CodeSuccessReslut chatroomStopDistributionMessageResult = rongCloud.chatroom
		...
		// 聊天室消息恢复分发方法
		CodeSuccessReslut chatroomResumeDistributionMessageResult = rongCloud.chatroom
		...
		// 移除封禁聊天室成员方法
		CodeSuccessReslut chatroomRollbackBlockUserResult = rongCloud.chatroom.rollbackBlockUser("userId1",
				"chatroomId1");
		...
		CodeSuccessReslut chatroomAddWhiteListUserResult = rongCloud.chatroom.addWhiteListUser("chatroomId",
		...
		// 发送短信验证码方法。
		SMSSendCodeReslut sMSSendCodeResult = rongCloud.sms.sendCode("13500000000", "dsfdsfd", "86", "1408706337",
				"1408706337");
