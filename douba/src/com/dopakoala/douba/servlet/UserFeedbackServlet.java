...
public class UserFeedbackServlet extends BaseServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			if (errcode == 0) {
				UserFeedback insertUserFeedback = new UserFeedback();
				insertUserFeedback.setContent(content);
				insertUserFeedback.setTitle(title);
				insertUserFeedback.setUid(uid);
				this.userFeedbackService.insertSelective(insertUserFeedback);
			}
