 ...
 */
@WebServlet("/card/getsign")
public class CardGetSignServlet extends BaseServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			if (errcode == 0) {
				switch (type) {
				case 1:
					String weekPeriod = AchieveUtils.getWeekPeriod(date);
					...
					break;
				case 2:
					String monthPeriod = AchieveUtils.getMonthPeriod(date);
					...
					break;
				case 3:
					String yearPeriod = AchieveUtils.getYearPeriod(date);
