 ...
 */
@WebServlet("/card/history")
public class CardHistoryServlet extends BaseServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			String token = "", month = "";
			int uid = 0, gid = 0, page = 0, pagesize = 10, targetUid = 0;
			long timestamp = 0;
			...
			Date endDate = null;
			if (errcode == 0) {
				String monthPeriod = AchieveUtils.getMonthPeriod(month);
				...
				selectGroupUserSignLog.setUid(targetUid);
				...
				selectGroupUserSignLogTemp.setUid(targetUid);
