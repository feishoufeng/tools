 ...
 */
@WebServlet("/group/isadd")
public class GroupIsAddServlet extends BaseServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			if (requestJson != null) {
				...
				if (!parameters.isNullObject() && parameters.containsKey("searchUid")) {
					searchUid = parameters.getInt("searchUid");
				}
			}
