...
public class JdbcTypeNameTranslator {
    ...
    static {
        ...
        typeToName.put(Types.BIGINT, "INTEGER"); //$NON-NLS-1$
        typeToName.put(Types.BINARY, "BINARY"); //$NON-NLS-1$
        typeToName.put(Types.BIT, "INTEGER"); //$NON-NLS-1$
        ...
        typeToName.put(Types.DECIMAL, "DOUBLE"); //$NON-NLS-1$
        ...
        nameToType.put("BIGINT", Types.INTEGER); //$NON-NLS-1$
        nameToType.put("BINARY", Types.BINARY); //$NON-NLS-1$
        nameToType.put("BIT", Types.INTEGER); //$NON-NLS-1$
        ...
        nameToType.put("DECIMAL", Types.DOUBLE); //$NON-NLS-1$
        ...
        nameToType.put("TINYINT", Types.INTEGER); //$NON-NLS-1$
